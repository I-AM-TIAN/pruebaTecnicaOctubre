...
El paciente ya fue seleccionado previamente, así que SOLO necesitas extraer:

1. Lista de MEDICAMENTOS con:
   - Nombre del medicamento
   - Dosificación (ej: "500mg", "10ml", "2 tabletas")
   - Cantidad de unidades prescritas
   - Instrucciones de uso (frecuencia, vía de administración, duración)
   
2. Notas generales (si las hay)

Combina toda la información de cada medicamento en el campo "instructions" de forma clara.
Ejemplo: "Tomar 1 tableta cada 8 horas después de las comidas por 7 días"

Extrae ÚNICAMENTE lo que se menciona en el audio. NO inventes información.`,
            },
      ...
      return JSON.parse(content);
        ...
        if(error instanceof SyntaxError) {
            console.error('OpenAI prescription structuring failed: Invalid JSON', error);
